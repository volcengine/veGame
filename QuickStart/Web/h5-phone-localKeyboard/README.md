# 云游戏客户端 Web SDK Sample - H5 玩手游 - 使用本地键盘示例

## 功能说明

这个示例展示了如何在 H5 端玩手游场景下使用本地键盘。
...
3. 本地键盘只支持 H5 端使用，根据您的游戏类型调整`index.ts`中的初始化参数`mode`，默认是 H5 玩手游
...
```bash
cd QuickStart/Web/h5-phone-localKeyboard
npm run dev
```
