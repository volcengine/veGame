# 云游戏客户端 Web SDK Sample - PC 玩手游 - 排队示例

## 功能说明

这个示例展示了如何在 PC 玩端游场景下排队。
...
3. 根据您的实际场景调整`index.ts`中的初始化参数`initConfig`，默认是 PC 玩端游，并且排队功能仅适用于端游，如需修改请参考下表
...
```bash
cd QuickStart/Web/pc-web-pc-queue
npm run dev
```
