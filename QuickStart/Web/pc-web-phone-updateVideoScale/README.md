# 云游戏客户端 Web SDK Sample - PC 玩手游 - 更新画面放缩比示例

## 功能说明

这个示例展示了如何在 PC 端玩手游场景下更新画面放缩比，主要用于游戏过程中容器（画布宽高比）发生变化时，更新调整画面的放缩比例，使游戏画面能够重新充满画布。
...
```bash
cd QuickStart/Web/pc-web-phone-updateVideoScale
npm run dev
```
