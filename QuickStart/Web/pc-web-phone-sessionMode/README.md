# 云游戏客户端 Web SDK Sample - PC 玩手游 - 设置或切换游戏的挂机模式示例

## 功能说明

这个示例展示了如何在 PC 端玩手游场景下设置或切换游戏的挂机模式。如果在启动游戏时，已通过 start 接口传入 sessionMode 参数设置启动游戏为挂机模式，可通过该接口将游戏切换为普通模式
...
```bash
cd QuickStart/Web/pc-web-phone-sessionMode
npm run dev
```
