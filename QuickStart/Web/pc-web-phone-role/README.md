# 云游戏客户端 Web SDK Sample - PC 玩手游 - 设置游戏玩家角色示例

## 功能说明

这个示例展示了如何在 PC 端玩手游场景下设置游戏玩家角色。在游戏中，设置游戏玩家的角色（操作者或观看者）。需要在初始化 sdk 时传入 podSettings 参数，开启游戏控制权转移功能。
...
```bash
cd QuickStart/Web/pc-web-phone-role
npm run dev
```
