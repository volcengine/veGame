...
@interface VeStreamStateInfo : NSObject
/**
 * 转推流房间ID
 */
 ...
 * 状态值
 */
@property(nonatomic, assign) int32_t state;
/**
 * 错误码
 */
@property(nonatomic, assign) int32_t error;
 ...
 * 是否需要订阅视频流
 */
@property (nonatomic, assign) BOOL needSubscribeStream;
...
/** RTC RoomProfile */
@property (nonatomic, assign) NSInteger rtcRoomProfile;
