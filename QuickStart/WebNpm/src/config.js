...
export const initConfig = {
  ...
  mode: MODE.CLOUD_PHONE_GAME, // 默认为云游戏手游，如果需要控制云游戏端游，请传 MODE.CLOUD_PC
...
export const startConfig = {
  ...
  token: {
    CurrentTime: import.meta.env.VEPHONE_TOKEN_CURRENT_TIME, // Token创建时间
    ExpiredTime: import.meta.env.VEPHONE_TOKEN_EXPIRED_TIME, // Token过期时间
